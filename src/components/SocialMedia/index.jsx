...
const SocialMedia = ({ isActive }) => {
  ...
  return (
    <div className={`tooltip-container ${isActive ? "active" : ""}`}>
      ...
      <span
        className="tooltip1"
        onClick={() => redirect("https://www.tiktok.com/@helado.silvia")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
      ...
      <span
        className="tooltip2"
        onClick={() => redirect("https://www.facebook.com/heladosilvia")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
      ...
      <span
        onClick={() => redirect("https://wa.me/541168287827")}
        className="tooltip3"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <span
        onClick={() => redirect("https://www.instagram.com/helado_silvia/")}
        className="tooltip4"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
